...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $item['item_image']  ?? "./assets/products/10pro.png";?>" alt="10pro" class="img-fluid"
            ...
            <div class="col-sm-6 py-5">
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">Ak<br>Deliverd</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
                ...
                <div id="order-details" class="font-rale d-flex flex-column text-dark">
                    <small>Delivery by : Nov 9 - Now 13</small>
                    <small>Sold by <a href="#">AK Electronics </a>(4.5 out of 5 | 18,198 ratings)</small>
                    ...
                    <div class="col-6">
                        ...
                        <div class="color my-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="p-2 color-primary-bg rounded-circle" style="color:#003859"><button
                                        class="btn font-size-14"></button></div>
            ...
            <div class="col-12">
                ...
                <p class="font-rale font-size-14">Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                    Repellat inventore vero
                    numquam error est ipsa, consequuntur temporibus debitis nobis sit, delectus officia ducimus
                    dolorum sed
                    corrupti. Sapiente optio sunt provident, accusantium eligendi eius reiciendis animi?
                    Laboriosam, optio qui?
